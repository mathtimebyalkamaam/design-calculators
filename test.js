    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=Montserrat:wght@700;800;900&display=swap" onload="this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&family=Montserrat:wght@700;800;900&display=swap"></noscript>
    ...
    <meta property="og:title" content="Cable Ampacity Calculator - Design Calculators - Electrical">
    <meta property="og:description" content="Professional cable ampacity calculator based on IEC 60364 & NEC. Calculates corrected ampacity, voltage drop, and short-circuit withstand.">
    ...
    "@graph": [
        {
            "@type": "WebApplication",
            "name": "Cable Ampacity Calculator - Design Calculators - Electrical",
            "url": "https://designcalculators.co.in/cable-thermal-rating.html",
            "description": "Professional cable ampacity calculator based on IEC 60364 & NEC. Calculates corrected ampacity, voltage drop, and short-circuit withstand.",
        ...
        },
        {
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "item": "https://designcalculators.co.in/indexele.html"
                },
                {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "Cable Ampacity Calculator",
                    "item": "https://designcalculators.co.in/cable-thermal-rating.html"
                }
            ]
        }
    ]
...
<body>
        ...
        <div class="container">
            <nav class="navbar">
                <a href="/" class="logo-container">
                    <img src="logo.png" alt="Design Calculators Logo" class="logo" width="42" height="42">
    ...
    <li class="dropdown">
        ...
        <div class="dropdown-menu">
            ...
            <div class="view-all-container">
                <a href="/indexele.html" class="view-all-link">View All Electrical Tools Ã¢â€ â€™</a>
            </div>
        </div>
    </li>
    ...
    <li class="dropdown">
        ...
        <div class="dropdown-menu">
            ...
            <div class="view-all-container">
                <a href="/indexinst.html" class="view-all-link">View All Instrumentation Tools Ã¢â€ â€™</a>
            </div>
        </div>
    </li>
    ...
    <li class="dropdown">
        ...
        <div class="dropdown-menu">
            ...
            <div class="view-all-container">
                <a href="/indexmech.html" class="view-all-link">View All Mechanical Tools Ã¢â€ â€™</a>
            </div>
        </div>
    </li>
    ...
    <main class="container">
            ...
            <div class="calculator-form">
                <form id="ampacity-form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="insulation-type" required>
                                <option value="pvc">PVC (70â„ƒ)</option>
                                <option value="xlpe">XLPE/EPR (90â„ƒ)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label for="ambient-temp">Ambient Temperature (â„ƒ) <span class="tooltip"><i class="fas fa-info-circle info-icon"></i><span class="tooltiptext">The temperature of the surrounding medium (air or ground) where the cable is installed. Higher ambient temperatures reduce ampacity.</span></span></label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group" id="soil-resistivity-group">
                            <label for="soil-resistivity">Soil Thermal Resistivity (KÂ·m/W) <span class="tooltip"><i class="fas fa-info-circle info-icon"></i><span class="tooltiptext">A measure of how well soil dissipates heat. Typical value is 2.5. Dry, sandy soil has higher resistivity (poorer heat dissipation).</span></span></label>
        ...
        <!-- NEWLY ADDED STATIC EDUCATIONAL SECTION -->
            <section class="section" id="cable-theory" style="margin-top: 40px; margin-bottom: 50px;">
        <div class="container">
            <div class="section-header" style="text-align: center; margin-bottom: 3rem;">
                <h2 class="section-title math-content"><i class="fas fa-book-reader" style="margin-right:10px;"></i>Professional Insights: The 3 Pillars of Cable Sizing</h2>
                <p class="section-subtitle">Sizing an electrical cable is a critical engineering task that goes far beyond just "picking a wire that fits." A correctly sized cable operates safely and efficiently for decades, while an incorrectly sized one is a catastrophic fire and equipment-failure hazard. This tool analyzes the three fundamental pillars of cable selection: <strong>Ampacity</strong>, <strong>Voltage Drop</strong>, and <strong>Short-Circuit Withstand</strong>.</p>
            </div>
            
            <div class="theory-grid" style="display: grid; gap: 3rem; grid-template-columns: 1fr;">
                
                <!-- Pillar 1 -->
                <div class="theory-card" style="background: var(--card); padding: 2.5rem; border-radius: 16px; box-shadow: var(--shadow); border-top: 5px solid var(--primary);">
                    <h3 style="color: var(--primary); margin-top: 0; margin-bottom: 1.5rem; font-size: 1.6rem;"><i class="fas fa-temperature-high" style="margin-right: 12px;"></i>1. Ampacity: Protecting the Cable</h3>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 3rem; align-items: start;">
                        <div>
                            <p style="font-size: 1.05rem;"><strong>What is it?</strong> Ampacity (a blend of "ampere" and "capacity") is the maximum continuous current a cable can carry without exceeding its insulation's thermal limit (e.g., 70&deg;C for PVC, 90&deg;C for XLPE).</p>
                            <p style="font-size: 1.05rem;">It is not a fixed number; it's a dynamic rating based on <strong>Heat In vs. Heat Out.</strong></p>
                            <ul style="padding-left: 20px; margin-bottom: 1.5rem; font-size: 1.05rem;">
                                <li><strong>Heat In:</strong> Generated by resistance ($$I^2R$$) losses.</li>
                                <li><strong>Heat Out:</strong> Dissipated into the environment.</li>
                            </ul>
                            <p style="font-size: 1.05rem;">When ambient temperature rises or cables are grouped in a trench, "Heat Out" is severely restricted. We capture this through strictly applied derating factors (k-factors) defined in IEC 60364-5-52.</p>
                        </div>
                        <div class="chart-container" style="background: var(--bg); padding: 1.5rem; border-radius: 12px; height: 100%;">
                            <h4 style="text-align: center; margin-top: 0; color: var(--heading); font-size: 1.1rem;">Base Ampacity Curve (XLPE Air)</h4>
                ...
                <!-- Derating Charts Grid -->
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 3rem;">
                    <div class="theory-card" style="background: var(--card); padding: 2.5rem; border-radius: 16px; box-shadow: var(--shadow); border-top: 5px solid var(--accent); display: flex; flex-direction: column;">
                        <h3 style="color: var(--accent); margin-top: 0; margin-bottom: 1rem; font-size: 1.4rem;">Grouping Impact ($$k_{group}$$)</h3>
                        <p style="font-size: 1.05rem; margin-bottom: 1.5rem;">Laying cables side-by-side means they mutually heat each other. Bundling 10 cables slashes their effective ampacity by over 50%!</p>
                        <div class="chart-container" style="background: var(--bg); padding: 1.5rem; border-radius: 12px; margin-top: auto;">
                            <h4 style="text-align: center; margin-top: 0; color: var(--heading); font-size: 1.1rem;">Mutual Heating Derating Profile</h4>
                    ...
                    <div class="theory-card" style="background: var(--card); padding: 2.5rem; border-radius: 16px; box-shadow: var(--shadow); border-top: 5px solid #EAB308; display: flex; flex-direction: column;">
                        <h3 style="color: #EAB308; margin-top: 0; margin-bottom: 1rem; font-size: 1.4rem;">Ambient Temperature ($$k_{temp}$$)</h3>
                        <p style="font-size: 1.05rem; margin-bottom: 1.5rem;">At 50&deg;C ambient, XLPE insulation is already near its limit before current even flows, necessitating extreme derating multipliers.</p>
                        <div class="chart-container" style="background: var(--bg); padding: 1.5rem; border-radius: 12px; margin-top: auto;">
                            <h4 style="text-align: center; margin-top: 0; color: var(--heading); font-size: 1.1rem;">Temperature Multiplying Factor</h4>
                            <div style="position: relative; height: 220px; width: 100%;">
                ...
                <!-- Pillar 2 -->
                <div class="theory-card" style="background: var(--card); padding: 2.5rem; border-radius: 16px; box-shadow: var(--shadow); border-top: 5px solid var(--secondary);">
                    <h3 style="color: var(--secondary); margin-top: 0; margin-bottom: 1.5rem; font-size: 1.6rem;"><i class="fas fa-car-battery" style="margin-right: 12px;"></i>2. Voltage Drop: Protecting the Load</h3>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 3rem; align-items: start;">
                        <div>
                            <p style="font-size: 1.05rem;">A cable can be <em>safe</em> (not exceeding ampacity) but still be <em>incorrect</em>. As current flows across the conductor impedance &Omega;/km, voltage plummets along the length.</p>
                            <p style="font-size: 1.05rem;">Undervoltage starves motors, forcing them to draw massive reactive current to sustain torque. This rapidly destroys mechanical pumps and compressors. Both IEC and NEC strictly bound acceptable voltage drop to <strong>3-5%</strong> of nominal service voltage.</p>
                        </div>
                        <div class="chart-container" style="background: var(--bg); padding: 1.5rem; border-radius: 12px; height: 100%;">
                            <h4 style="text-align: center; margin-top: 0; color: var(--heading); font-size: 1.1rem;">Voltage Drop vs Cable Length (At Selected Load)</h4>
                            <div style="position: relative; height: 250px; width: 100%;">
                ...
                <!-- Pillar 3 -->
                <div class="theory-card" style="background: var(--card); padding: 2.5rem; border-radius: 16px; box-shadow: var(--shadow); border-top: 5px solid var(--danger);">
                    <h3 style="color: var(--danger); margin-top: 0; margin-bottom: 1.5rem; font-size: 1.6rem;"><i class="fas fa-bolt" style="margin-right: 12px;"></i>3. Adiabatic Short-Circuit Withstand</h3>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 3rem; align-items: start;">
                        <div>
                            <p style="font-size: 1.05rem;">This is the "emergency" rating. When a bolted short circuit hits 25,000 Amps, the conductor heats up exponentially in milliseconds. </p>
                            <p style="font-size: 1.05rem;">The cable cannot dissipate heat fast enough, so it operates adiabatically. If the conductor ($$S^2$$) is too thin for the fault duration ($$t$$) allowed by your breaker, it will physically vaporize inside the tray.</p>
                            <div class="formula-block math-content" style="background: var(--bg); padding: 1.2rem; border-radius: 8px; margin-top: 1.5rem; text-align: center; border-left: 4px solid var(--danger);">
                                $$ S = \\frac{\\sqrt{I^2t}}{k} $$
                            </div>
                        </div>
                        <div class="chart-container" style="background: var(--bg); padding: 1.5rem; border-radius: 12px; height: 100%;">
                            <h4 style="text-align: center; margin-top: 0; color: var(--heading); font-size: 1.1rem;">Fault Duration vs Withstand Current (kA)</h4>
                            <div style="position: relative; height: 250px; width: 100%;">
    ...
    <!-- FAQS Section -->
    <section class="section faq-section" id="faq" style="background: var(--bg); padding: 60px 0;">
        <div class="container">
            <h2 class="section-title text-center" style="font-family: 'Montserrat', sans-serif; text-align: center; margin-bottom: 2rem;">Top 8 FAQs in Cable Optimization</h2>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 2rem;">
                
                <div class="card" style="margin-bottom: 0;">
                    <h3 style="margin-top: 0; color: var(--primary); font-size: 1.2rem;"><i class="fas fa-question-circle"></i> 1. Why is ground temperature assumed to be 20&deg;C?</h3>
                    <p style="font-size: 1rem; color: var(--text);">According to IEC 60364-5-52, the default reference for buried cables is a steady-state earth temperature of 20&deg;C. The air reference is 30&deg;C. In warmer climates like the Middle East, ground temperature might be shifted to 30&deg;C to be locally accurate.</p>
                </div>
                <div class="card" style="margin-bottom: 0;">
                    <h3 style="margin-top: 0; color: var(--primary); font-size: 1.2rem;"><i class="fas fa-question-circle"></i> 2. Why is grouping derating so brutal?</h3>
                    <p style="font-size: 1rem; color: var(--text);">Because heat rises and dissipates cumulatively. If 10 cables are stacked in a trench, the central cables act as pure heating elements trapped by the outer ones ($$k_g \approx 0.45$$). Spacing them out by 1x diameter negates some of this penalty.</p>
                </div>
                <div class="card" style="margin-bottom: 0;">
                    <h3 style="margin-top: 0; color: var(--primary); font-size: 1.2rem;"><i class="fas fa-question-circle"></i> 3. PVC vs. XLPE Insulation?</h3>
                    <p style="font-size: 1rem; color: var(--text);">PVC melts at lower continuous operating temperatures (70&deg;C) while XLPE/EPR sustains 90&deg;C. Upgrading from PVC to XLPE inherently allows up to 25% higher base ampacity in identical conductor constraints.</p>
                </div>
                <div class="card" style="margin-bottom: 0;">
                    <h3 style="margin-top: 0; color: var(--primary); font-size: 1.2rem;"><i class="fas fa-question-circle"></i> 4. How does soil resistivity affect burial?</h3>
                    <p style="font-size: 1rem; color: var(--text);">Thermal resistivity measures soil's resistance to heat flow. Dry sand traps heat (resistivity ~3.0 K&middot;m/W). Damp clay conducts heat beautifully (~1.0 K&middot;m/W). High resistivity heavily strangles cable ampacity.</p>
                </div>
                <div class="card" style="margin-bottom: 0;">
                    <h3 style="margin-top: 0; color: var(--primary); font-size: 1.2rem;"><i class="fas fa-question-circle"></i> 5. What if the voltage drop exceeds 5%?</h3>
                    <p style="font-size: 1rem; color: var(--text);">If heat runs fine but voltage drops 9%, you MUST step up the wire cross-sectional thickness ($$mm^2$$) regardless of Ampacity. Increasing Copper thickness strictly trims the line impedance R & X.</p>
                </div>
                <div class="card" style="margin-bottom: 0;">
                    <h3 style="margin-top: 0; color: var(--primary); font-size: 1.2rem;"><i class="fas fa-question-circle"></i> 6. Copper vs. Aluminum Conductors?</h3>
                    <p style="font-size: 1rem; color: var(--text);">Copper is far more conductive ($$\sigma$$) and requires much smaller trenching. Aluminum is significantly cheaper but possesses a larger diameter for identical current loads, scaling up raceway constraints.</p>
                </div>
                <div class="card" style="margin-bottom: 0;">
                    <h3 style="margin-top: 0; color: var(--primary); font-size: 1.2rem;"><i class="fas fa-question-circle"></i> 7. Why use 0.8 power factor for VD equations?</h3>
                    <p style="font-size: 1rem; color: var(--text);">Industrial motor-heavy plants invariably fall toward highly inductive trailing power factors. Standard IEC analysis models the reactive penalty $X\sin\phi$ around 0.8 ~ 0.85 PF lagging.</p>
                </div>
                <div class="card" style="margin-bottom: 0;">
                    <h3 style="margin-top: 0; color: var(--primary); font-size: 1.2rem;"><i class="fas fa-question-circle"></i> 8. Does adiabatic K-factor vary?</h3>
                    <p style="font-size: 1rem; color: var(--text);">Yes! IEC 60364 limits Copper+XLPE to k=143, while Copper+PVC limits to k=115. This is purely because XLPE survives the flash spike to 250&deg;C, but PVC irreparably melts past 160&deg;C.</p>
                </div>
